    ...
    <div className="shell">
      ...
      <main className="container">
        <section className="hero">
          <div className="heroMain">
            ...
            <p>Discover products from trusted sellers, compare prices, find deals, and shop from one {businessName} marketplace.</p>
      ...
      <footer className="footer">
        <div className="footerInner">
          <div><h3>{businessName}</h3><p>Rwanda-first marketplace connecting customers with trusted sellers and products.</p></div>
